...
There is no build step, linter, or CI pipeline — `npm test` must be run locally before pushing. 274 assertions across the 7 suites as of this writing.
